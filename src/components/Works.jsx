    ...
    return (
        <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
            <Tilt
                ...
                className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-fill"
            >
                <div className="relative w-full h-[230px]">
                    <img src={image} alt={name} className="w-full h-full object-cover rounded-2xl" />
                    {/*          <iframe
                            src="https://portfolio-3d-ten.vercel.app/#work"
                            alt={name}
                    ...
                    <div className="absolute inset-0 flex justify-end m-3 card-img_cover">
                        ...
                        >
                            <img src={github} alt="github" className="w-1/2 h-1/2 object-contain-contain" />
                        </div>
                    </div>
                </div>
                <div className="mt-5">
